...
const credit = Deno.env.get('CREDIT') || 'DenoBy-KPBYKP';
...
<body>
    <div class="container">
        ...
        <div class="footer">
            Powered by Deno. For support, contact <a href="https://t.me/KP_CHANNEL_KP" target="_blank">@KPBYKP</a>.
        </div>
    </div>
</body>
</html>
      ...
      case `/${userID}`: {
        ...
        const vlessMain = `vless://${userID}@${hostName}:${port}?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2FKP-CHANNEL#${credit}`;      
        const ck = `vless://${userID}\u0040${hostName}:443?encryption=none%26security=tls%26sni=${hostName}%26fp=randomized%26type=ws%26host=${hostName}%26path=%2FKP-CHANNEL%23${credit}`;
